...
\textit{Hamiltonian:} $A_g(v)$ is defined as follows:
\begin{equation*}
...
In a more convenient notation, $A_g(v)B_h(p) = B_{ghg^{-1}}(p)A_g(v)$. This means that we start traversing the plaquette $p$ counterclockwise from vertex $v$.
